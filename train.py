...
if __name__ == '__main__':
    ...
    parser.add_argument('--warm_epochs', default=10, type=int, help='linear warmup epochs')
    ...
    parser.add_argument('--grad_accum', default=4, type=int, help='gradient accumulation steps (effective batch = batch_size * grad_accum * GPUs)')
    parser.add_argument('--no_ckpt', action='store_true', default=False, help='disable gradient checkpointing (faster, uses more VRAM)')
    ...
    parser.add_argument('--val_interval', default=1, type=int,
                        help='validate every N epochs (1=every epoch, always validates last epoch)')
